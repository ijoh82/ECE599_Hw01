...
(cl:in-package joh_runtime_monitoring-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name joh_runtime_monitoring-msg:<Num> is deprecated: use joh_runtime_monitoring-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joh_runtime_monitoring-msg:num-val is deprecated.  Use joh_runtime_monitoring-msg:num instead.")
  (num m))
